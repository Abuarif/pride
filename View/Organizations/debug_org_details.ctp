...
<div style="padding-top:40px;">
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td style="padding-left:8px;width:600px;height:40px;text-align:left;">Full Name</td>
				...
				<td style="width:120px;height:40px;text-align:center;">Key Personnel</td>
				<td style="width:120px;height:40px;text-align:center;">Shares Alloted</td>
			</tr>
    ...
    <div style="padding-top:40px;">
    	<table width="100%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td style="width:50px;height:40px;text-align:center;">No</td>
				<td style="padding-left:8px;width:1500px;height:40px;text-align:left;">Full Name</td>
				<td style="width:250px;height:40px;text-align:center;">Position</td>
			</tr>
			<?php 
    ...
    <div style="padding-top:15px;">
    	<table width="100%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td style="width:50px;height:40px;text-align:center;">No</td>
				<td style="padding-left:8px;width:2000px;height:40px;text-align:left;">Title</td>
			</tr>
			<?php 
	...
	<div style="padding-top:40px;">
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td style="width:50px;height:40px;text-align:center;">No</td>
				<td style="width:200px;height:40px;text-align:center;">Invoice No</td>
				...
				<td style="width:200px;height:40px;text-align:center;">Receipt File</td>
			...
			<tr>
				...
				<td style="height:40px;text-align:center;">
					<?php 
						if (!empty($advice['receipt_attachment'])) {
							echo $this->Html->link('Download', "/payments/".$advice['receipt_attachment'], array('target' => '_blank'));
						} else {
							echo 'Pending receipt file';
						} 
					?>
				</td>
				<td style="height:40px;text-align:center;">
