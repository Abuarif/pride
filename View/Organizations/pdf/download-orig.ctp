...
<section class="content-header">
	<h1>
		New Advertiser Approval Preview
	</h1>
	<ol class="breadcrumb">
...
<!-- End Approval -->
		...
		<!-- <div class="panel panel-success">
			  ...
			  <div class="panel-body" align="center">
					<?php
						echo 
							$this->Html->image('/uploads/factoryIco.png', array('style' => 'height:22px;width:22px')).
							'&nbsp;&nbsp;'.
							$this->Html->link(__('List All Organizations'), array('action' => 'index'));
					?>
			</div>
		</div>
	</div> -->
