...
<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">C A M P A I G N  &nbsp;&nbsp; P R O G R E S S </h3>
					</div>
	...
	<tr>
		...
		<td style="text-align:left;height:30px;">&nbsp;<?php echo $this->Html->link($progress['campaign']['name'], array('controller' => 'campaign_orders', 'action' => 'view', $progress['co']['id'])); ?></td>
		...
		<td style="text-align:center;height:30px;">
			...
			<div class="progress" style="margin-bottom:0px">
			  <div class="progress-bar progress-bar-success progress-bar-striped" style="width: <?php echo ($progress['0']['totalProvisionedBus']/$progress['pack']['quantity']*100); ?>%">
				<span class="sr-only"><?php echo $progress['0']['totalProvisionedBus'];?></span>
			  </div>
			  <div class="progress-bar progress-bar-danger progress-bar-striped" style="width: <?php echo ($progress['0']['balance']/$progress['pack']['quantity']*100); ?>%">
				<span class="sr-only"><?php echo $progress['0']['balance'];?></span>
			  </div>
			</div>
