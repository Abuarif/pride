        ...
        <tr>
            <td align="right">
                ...
                <table width="700" border="0" cellpadding="0" cellspacing="0" style="border-width:1px; font-family:Verdana, Geneva, sans-serif;font-size:small;">
                  ...
                  <tr>
                    <td style="text-align:left;height:30px;vertical-align:text-top;">Package Name</td>
                    <td style="text-align:center;width:30px;height:30px;vertical-align:text-top;">:</td>
                    <td style="text-align:left;height:30px;vertical-align:text-top;"><?php echo $user['email']['packageName']; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <?php
                        $url = Router::url(array(
                            ...
                            'action' => 'view', $user['email']['campaignOrderId']
                        ), true);
