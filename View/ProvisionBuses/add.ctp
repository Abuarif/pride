...
<div class="provisionBuses row-fluid">
	<div class="span8">
		...
		<!-- Commented and tested by: Mohd Nizar Abd Azik [15/08/2014][08:31 AM] -->
		<?php
			//echo $this->Croogo->adminTab(__d('croogo', 'Provision Bus'), '#provision-bus');
			//echo $this->Croogo->adminTabs();
		?>
		<li class="active">
				<a href="#provision-bus" data-toggle="tab">Provision Bus</a>
		</li>
		</ul>

		<div class="tab-content">
			<div id='provision-bus' class="tab-pane active">
			<?php
