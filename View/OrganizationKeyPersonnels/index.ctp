<div class="organizationKeyPersonnels index">
	<h2><?php echo __('Organization Key Personnels'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $organizationKeyPersonnel['OrganizationKeyPersonnel']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $organizationKeyPersonnel['OrganizationKeyPersonnel']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $organizationKeyPersonnel['OrganizationKeyPersonnel']['id']), array(), __('Are you sure you want to delete # %s?', $organizationKeyPersonnel['OrganizationKeyPersonnel']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
