<div class="organizationTypes index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $organizationType['OrganizationType']['id']), array(), __('Are you sure you want to delete # %s?', $organizationType['OrganizationType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
