...
<section class="content-header">
	<h1>
		Edit Job Tasks Assignment
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-external-link"></i>Home</a></li>
		<li><a href="#">List of Job Task Assignments</a></li>
		<li class="active">Edit Job Tasks Assignment</li>
	</ol>
</section>

<section class="content">
	<?php echo $this->Form->create('JobTaskAssignment'); ?>
	<div class="panel panel-default">
	  <div class="panel-body">
		<div class="tab-content">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td style="height:40px;width:10%;color:black">Job ID</td>
