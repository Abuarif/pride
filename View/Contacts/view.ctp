<div id="contact-<?php echo $contact['Contact']['id']; ?>" class="">
	...
	<?php
		...
		if (!empty($this->request->data)) {
			...
			echo $this->Form->hidden('Message.name', array('label' => __d('croogo', 'Your name'), 'value' => $this->Session->read('Auth.User.name')));
		echo $this->Form->hidden('Message.email', array('label' => __d('croogo', 'Your email'), 'value' => $this->Session->read('Auth.User.email')));
