<div class="organizationAttachments index">
	<h2><?php echo __('Organization Attachments'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $organizationAttachment['OrganizationAttachment']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $organizationAttachment['OrganizationAttachment']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $organizationAttachment['OrganizationAttachment']['id']), array(), __('Are you sure you want to delete # %s?', $organizationAttachment['OrganizationAttachment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
