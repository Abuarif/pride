<div class="workOrderApprovals index">
	<h2><?php echo __('Work Order Approvals'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $workOrderApproval['WorkOrderApproval']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $workOrderApproval['WorkOrderApproval']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $workOrderApproval['WorkOrderApproval']['id']), array(), __('Are you sure you want to delete # %s?', $workOrderApproval['WorkOrderApproval']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
