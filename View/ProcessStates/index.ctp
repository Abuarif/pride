<div class="processStates index">
	<h2><?php echo __('Process States'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($processState['ProcessState']['status']); ?>&nbsp;</td>
		<td><?php echo h($processState['ProcessState']['updated']); ?>&nbsp;</td>
		<td><?php echo h($processState['ProcessState']['updated_by']); ?>&nbsp;</td>
		<td><?php echo h($processState['ProcessState']['created']); ?>&nbsp;</td>
		<td><?php echo h($processState['ProcessState']['created_by']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $processState['ProcessState']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $processState['ProcessState']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $processState['ProcessState']['id']), array(), __('Are you sure you want to delete # %s?', $processState['ProcessState']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
