...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Update Approval Status</li>
	</ol>
</section>
	  ...
	  <div class="panel-body">
		<div class="tab-content">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td style="height:40px;color:black">Approval Evidence (stamped copy)</td>
			  ...
			  <tr>
				<td style="height:40px;width:20%;color:black">Notes</td>
				<td style="width:30px;">:</td>
