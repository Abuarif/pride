<div class="busStatuses index">
	<h2><?php echo __('Bus Statuses'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $busStatus['BusStatus']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $busStatus['BusStatus']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $busStatus['BusStatus']['id']), array(), __('Are you sure you want to delete # %s?', $busStatus['BusStatus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
