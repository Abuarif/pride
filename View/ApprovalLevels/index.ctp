<div class="approvalLevels index">
	<h2><?php echo __('Approval Levels'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $approvalLevel['ApprovalLevel']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $approvalLevel['ApprovalLevel']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $approvalLevel['ApprovalLevel']['id']), array(), __('Are you sure you want to delete # %s?', $approvalLevel['ApprovalLevel']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
