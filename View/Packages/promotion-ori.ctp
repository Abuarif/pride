		...
		<?php foreach ($packages as $package){ ?>
			<div class="col-lg-4 col-xs-6">
				...
				<div class="small-box bg-aqua">
					...
					<?php echo $this->Html->link(' Purchase this package', array('controller' => 'campaign_orders', 'action' => 'purchase_promotion', $package['Package']['id']), array('class' => 'small-box-footer fa fa-shopping-cart', 'confirm' => __('Are you sure you want to purchase %s?', $package['Package']['name']))); ?>
				</div>
			</div><!-- ./col -->
			<?php } ?>
