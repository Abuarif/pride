...
<section class="content">
	...
	<div class="box box-primary pull-right">
        <div class="box-header">
            <h3 class="box-title">Campaign <?php echo h($counter) . ': ' . h($campaign['Organization']['name'].': '.$campaign['Campaign']['name']); ?></h3>
							...
							<div class="timeline-item col-md-6">
								...
								<?php } else { ?>
									...
									<div class='timeline-footer'>
										<a href="<?=$this->webroot.'pride/campaign_orders/add';?>" class="btn btn-success"><i class="fa fa-fw fa-plus"></i>Add Package to campaign</a>
									</div>
								<?php } ?>
							</div>
						</li>
